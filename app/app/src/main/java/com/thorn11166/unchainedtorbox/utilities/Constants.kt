...
const val TORBOX_LEGACY_URL = "https://api.torbox.app/api/"

// API Key for TorBox authentication (replaced OAuth)
const val TORBOX_API_KEY_PREF = "torbox_api_key"

// Old constants kept for reference/compatibility
@Deprecated("Real-Debrid no longer supported", level = DeprecationLevel.WARNING)
const val BASE_AUTH_URL = "https://api.torbox.app/v1/"

const val REFERRAL_LINK = "https://torbox.app"
const val ACCOUNT_LINK = "https://torbox.app/account"
